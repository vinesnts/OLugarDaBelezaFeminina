...
Scenario: novo cliente
	...
	When Eu preencho o campo nome com "Raquel" o telefone com 81999999999 a senha com "12345678" e o campo repita senha com "12345678"
...
Scenario: novo cliente ja existente com campo telefone existente
	Given Eu estou na pagina inicial do site
	And Eu vejo que o telefone 81999999999 já existe
	And Eu clico no botao novo cliente
	When Eu preencho o campo nome com "Damiana" o telefone com 81999999999 a senha com "12345678" e o campo repita senha com "12345678"
	And Eu clico em cadastrar cliente
...
Scenario: novo cliente com o campo repita senha invalido
	Given Eu estou na pagina inicial do site
	And Eu clico no botao novo cliente
	When Eu preencho o campo nome com "Raquel" o telefone com 87999999999 a senha com "12345678" e o campo repita senha com "87654321"
	And Eu clico em cadastrar cliente
...
Scenario: novo cliente invalido devido ao campo telefone
	Given Eu estou na pagina inicial do site
	And Eu clico no botao novo cliente
	When Eu preencho o campo nome com "Raquel" o telefone com "aabccccdddd" a senha com "12345678" e o campo repita senha com "12345678"
	And Eu clico em cadastrar cliente
...
Scenario: novo cliente invalido devido campo senha
	Given Eu estou na pagina inicial do site
	And Eu clico no botao novo cliente
	When Eu preencho o campo nome com "Raquel" o telefone com 81999999999 a senha com "12345" e o campo repita senha com "12345"
	And Eu clico em cadastrar cliente
